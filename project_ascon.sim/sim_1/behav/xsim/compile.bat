...
REM
REM Generated by Vivado on Wed Apr 01 13:19:57 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj top_ascon_tb_2_vlog.prj"
call xvlog  --incr --relax -L uvm -prj top_ascon_tb_2_vlog.prj -log xvlog.log
