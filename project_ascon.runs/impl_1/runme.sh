...
HD_PWD='C:/Users/titi7/Desktop/keysights/project_ascon/project_ascon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ascon.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ascon.tcl -notrace
