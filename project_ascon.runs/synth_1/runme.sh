...
HD_PWD='C:/Users/titi7/Desktop/keysights/project_ascon/project_ascon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ascon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ascon.tcl
